...
export const PriceBandCodes = (props: {nameProp: string | null}) => {
    ...
    return (
        <div className="flex flex-col w-full text-secondary">
            ...
            <p className="text-xs font-light mb-2 ml-2 text-secondary">Insert one or more price band codes. <br/>(divide them with: " , ")</p>
